...
public class starcustom extends ShapeOfView {
    private int noOfPoints = 5;

    public starcustom(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public starcustom(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public starcustom(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
